...
const DetailDriver: React.FC<DetailDriverProps> = ({
  ...
  const handleDeleteShipment = async (idItem: number) => {
    // console.log("SHIPMENT", shipmentcurrent);
    try {
      const DELETETASK = new DriversOperation();
      const data: DeletingDriverTaskCondition = {
        id: idItem,
      };
      // console.log("Data Delete", data);
      const response = await DELETETASK.deleteTask(data);
