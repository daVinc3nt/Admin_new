...
import { AdministrativeOperation, StaffsOperation, UpdatingStaffCondition, UpdatingStaffInfo } from "@/TDLib/tdlogistics";
...
const DetailStaff: React.FC<DetailStaffProps> = ({ onClose, dataInitial }) => {
  ...
  const handleSaveClick = () => {
    ...
    if ((updateData.role == "SHIPPER" || updateData.role == "AGENCY_SHIPPER") && !selectedWard.value) return;
    let dataSubmit = (updateData.role == "SHIPPER" || updateData.role == "AGENCY_SHIPPER") ? { ...updateData, managed_wards: [selectedWard.value] } : updateData
          ...
          <div className="grid grid-cols-2 ">
            ...
            <div className="">
              <div className="flex flex-col gap-5">
                ...
                <div className="flex">
                  {(data.role == "SHIPPER" || data.role == "AGENCY_SHIPPER") && isEditing && <div className="w-[98%] mt-2 mb-10">
