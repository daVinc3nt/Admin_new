...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        RedGradient: "linear-gradient(to top, #890010, #990012)",
        DarkRedGradient: "linear-gradient(to left, #EE0033, #EE0033)",
        LitghRedGradient:
          "linear-gradient(-45deg, #ff5959, #ff4040, #ff0d6e, #ff8033,#d74177)",
        confeti: 'url("/confetti.png")',
        whiteRedGradient: "linear-gradient(45deg, #FF0000, #FF7878)",
      },
      height: {
        104: "26rem",
        112: "28rem",
